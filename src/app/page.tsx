      ...
      <motion.section variants={VARIANTS_SECTION} transition={TRANSITION_SECTION}>
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            I build websites, interactive platforms and web apps for events, museums, and cultural
            projects. I run{" "}
            <a
              href="https://kraftend.com"
              target="_blank"
              rel="noopener noreferrer"
            ...
            and often collaborate with partner agencies; much of my work has supported larger
            organizations like{" "}
            <a
      ...
      <motion.section variants={VARIANTS_SECTION} transition={TRANSITION_SECTION}>
        ...
        <div className="flex flex-col space-y-8 text-sm">
          {PROJECTS.map((project) => (
            <div
              className="relative overflow-hidden flex w-full flex-col sm:flex-row"
              key={project.id}
            >
              <div className="sm:basis-3/12">
                <p className="text-zinc-600 dark:text-zinc-400">{project.year}</p>
              </div>
